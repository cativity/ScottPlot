...
internal class PopulationTests
{
    ...
    public void TestPopulationMean()
    {
        ...
        pop.Variance.Should().BeApproximately(25865.759, 1e-3);
        pop.StandardDeviation.Should().BeApproximately(160.82835, 1e-5);
        pop.StandardError.Should().BeApproximately(16.082835, 1e-5);
