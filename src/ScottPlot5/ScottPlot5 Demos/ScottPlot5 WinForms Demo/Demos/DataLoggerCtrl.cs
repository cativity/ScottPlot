...
public partial class DataLoggerCtrl : UserControl
{
    ...
    private void InitPlots()
    {
        ...
        CircularBuffer<Coordinates> data1 = new CircularBuffer<Coordinates>(1000);
        Logger1 = new ScottPlot.Plottables.DataLogger(data1) { Color = Colors.C0, Rotated = Rotated };
        formsPlot.Plot.Add.Plottable(Logger1);

        CircularBuffer<Coordinates> data2 = new CircularBuffer<Coordinates>(1000);
    ...
    private void FormsPlot_MouseMove(object sender, MouseEventArgs e)
    {
        ...
        if (nearest.IsReal)
        {
            ...
            Coordinates coordinates = nearest.Coordinates;
