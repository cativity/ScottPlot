...
public partial class CustomAxis : Form, IDemoWindow
{
    ...
    public string Description => "How to create a custom axis class that implements IAxis to create totally customizable axis panels";
    ...
    public CustomAxis()
    {
        ...
        LeftAxisWithSubtitle customLeftAxis = new LeftAxisWithSubtitle { LabelText = "Custom Y Axis", SubLabelText = "With a cool subtitle!" };
    ...
    internal class LeftAxisWithSubtitle : YAxisBase
    {
        ...
        public LabelStyle SubLabelStyle { get; set; } = new LabelStyle { Rotation = -90, };

        public override Edge Edge => Edge.Left;

        public LeftAxisWithSubtitle() => TickGenerator = new NumericAutomatic();
        ...
        public override void Render(RenderPack rp, float size, float offset)
        {
            ...
            Pixel subLabelPoint = new Pixel(x + labelHeight, rp.DataRect.VerticalCenter);
