...
public class RadialGauge : ICategory
{
    ...
    public class RadialGaugeSequential : RecipeBase
    {
        ...
        public override string Description => "Sequential gauge mode indicates that the base of each gauge starts at the tip of the previous gauge.";
        ...
        public override void Execute()
        {
            ...
            RadialGaugePlot radialGaugePlot = MyPlot.Add.RadialGaugePlot(values);
            radialGaugePlot.GaugeMode = RadialGaugeMode.Sequential;
        }
    }
    ...
    public class RadialGaugeReverse : RecipeBase
    {
        ...
        public override string Description => "Gauges are displayed from the center outward by default but the order can be customized.";
    ...
    public class RadialGaugeModeSingle : RecipeBase
    {
        ...
        public override void Execute()
        {
            ...
            RadialGaugePlot radialGaugePlot = MyPlot.Add.RadialGaugePlot(values);
            radialGaugePlot.GaugeMode = RadialGaugeMode.SingleGauge;
    ...
    public class RadialGaugeDirection : RecipeBase
    {
        ...
        public override string Description => "The direction of gauges can be customized. Clockwise is used by default.";
    ...
    public class RadialGaugeSize : RecipeBase
    {
        ...
        public override string Description => "The empty space between gauges can be adjusted as a fraction of their width. ";
    ...
    public class RadialGaugeLabelFontPct : RecipeBase
    {
        ...
        public override string Description => "Size of the gauge level text as a fraction of the gauge width.";
    ...
    public class RadialGaugeLabelColor : RecipeBase
    {
        ...
        public override string Description => "Level text fonts may be customized.";
    ...
    public class RadialGaugeLegend : RecipeBase
    {
        ...
        public override string Description => "Radial gauge labels will appear in the legend if they are assigned. ";
