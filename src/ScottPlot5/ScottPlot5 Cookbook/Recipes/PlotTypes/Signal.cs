...
public class Signal : ICategory
{
    ...
    public class SignalQuickstart : RecipeBase
    {
        ...
        public override string Description
            => "Signal plots are best for extremely large datasets. "
    ...
    public class SignalStyling : RecipeBase
    {
        ...
        public override void Execute()
        {
            ScottPlot.Plottables.Signal sig1 = MyPlot.Add.Signal(Generate.Sin());
            sig1.Color = Colors.Magenta;
            sig1.LineWidth = 10;
            sig1.LegendText = "Sine";

            ScottPlot.Plottables.Signal sig2 = MyPlot.Add.Signal(Generate.Cos());
    ...
    public class SignalOffset : RecipeBase
    {
        ...
        public override void Execute()
        {
            ...
            ScottPlot.Plottables.Signal sig1 = MyPlot.Add.Signal(values);
            sig1.LegendText = "Default";

            ScottPlot.Plottables.Signal sig2 = MyPlot.Add.Signal(values);
    ...
    public class SignalScaleY : RecipeBase
    {
        ...
        public override void Execute()
        {
            ...
            double[] values = Generate.Sin(51);
            ScottPlot.Plottables.Signal signal = MyPlot.Add.Signal(values);
    ...
    public class SignalMarkerSize : RecipeBase
    {
        ...
        public override string Description => "Signal plots can have markers displayed at each point which are only visible when the plot is zoomed in.";

        [Test]
        public override void Execute()
        {
            ScottPlot.Plottables.Signal sig1 = MyPlot.Add.Signal(Generate.Cos());
            sig1.LegendText = "Default";
            sig1.Data.YOffset = 3;
            ...
            ScottPlot.Plottables.Signal sig3 = MyPlot.Add.Signal(Generate.Cos());
    ...
    public class SignalRenderIndexes : RecipeBase
    {
        ...
        public override string Description
            => "Even if a signal plot references a "
        ...
        public override void Execute()
        {
            ...
            ScottPlot.Plottables.Signal sigAll = MyPlot.Add.Signal(values);
            sigAll.LegendText = "Full";
            sigAll.Data.YOffset = 80;

            ScottPlot.Plottables.Signal sigLeft = MyPlot.Add.Signal(values);
            sigLeft.LegendText = "Left";
            sigLeft.Data.YOffset = 60;
            sigLeft.Data.MaximumIndex = 700;

            ScottPlot.Plottables.Signal sigRight = MyPlot.Add.Signal(values);
            sigRight.LegendText = "Right";
            sigRight.Data.YOffset = 40;
            sigRight.Data.MinimumIndex = 300;

            ScottPlot.Plottables.Signal sigMid = MyPlot.Add.Signal(values);
    ...
    public class SignalGeneric : RecipeBase
    {
        ...
        public override string Description => "Signal plots support generic data types, although double is typically the most performant.";
    ...
    public class SignalDateTime : RecipeBase
    {
        ...
        public override void Execute()
        {
            ...
            ScottPlot.Plottables.Signal sig = MyPlot.Add.Signal(ys);
