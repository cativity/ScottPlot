...
public class DateTimeAxes : ICategory
{
    ...
    public class DateTimeAxisMixed : RecipeBase
    {
        ...
        public override string Description
            => "DateTime axes are achieved using Microsoft's "
        ...
        public override void Execute()
        {
            ...
            DateTime startDateTime = new DateTime(2024, 1, 1);
            ...
            const double deltaDouble = 1.0 / 24.0; // an hour is 1/24 of a day
    ...
    public class DateTimeAxisCustomFormatter : RecipeBase
    {
        ...
        public override void Execute()
        {
            ...
            MyPlot.RenderManager.RenderStarting += (_, _) =>
            {
    ...
    public class DateTimeAxisFixedIntervalTicks : RecipeBase
    {
        ...
        public override string Description
            => "Make ticks render at fixed intervals. Optionally make the ticks render "
        ...
        public override void Execute()
        {
            ...
            MyPlot.Add.Scatter(dates, ys);
            DateTimeXAxis dtAx = MyPlot.Axes.DateTimeTicksBottom();

            // Create fixed-intervals ticks, major ticks every 6 hours, minor ticks every hour
            dtAx.TickGenerator = new DateTimeFixedInterval(new Hour(),
                                                           6,
                                                           new Hour(),
                                                           1,
