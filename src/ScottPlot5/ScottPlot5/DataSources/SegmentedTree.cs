    ...
    where T : struct, IComparable
{
    ...
    private T[] _treeMin;
    private T[] _treeMax;
    private int _n; // size of each Tree
    ...
    public SegmentedTree()
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(T), "Unsupported data type, provide convertable to double data types");
        }
    ...
    {
        _sourceArray = data ?? throw new ArgumentNullException(nameof(data), "Data cannot be null");
    ...
    public void UpdateTrees()
    {
        ...
        try
        {
            ...
            {
                _treeMin[(_n / 2) + (_sourceArray.Length / 2)] = _sourceArray[^1];
                _treeMax[(_n / 2) + (_sourceArray.Length / 2)] = _sourceArray[^1];
            }
