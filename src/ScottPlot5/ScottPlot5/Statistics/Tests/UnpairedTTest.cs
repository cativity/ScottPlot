...
public class UnpairedTTest
{
    ...
    public static double Gauss(double z)
    {
        ...
        {
            double y = Math.Abs(z) / 2; // 209 scratch variable
            ...
            {
                double w = y * y; // 209 scratch variable

                p = ((((((((((((((((0.000124818987 * w) - 0.001075204047) * w) + 0.005198775019) * w) - 0.019198292004) * w) + 0.059054035642) * w)
                           - 0.151968751364)
                          * w)
                         + 0.319152932694)
                        * w)
            ...
            else
            {
                ...
                p = (((((((((((((((((((((((((((-0.000045255659 * y) + 0.000152529290) * y) - 0.000019538132) * y) - 0.000676904986) * y) + 0.001390604284) * y)
                                      - 0.000794620820)
                                     * y)
                                    - 0.002034254874)
                                   * y)
