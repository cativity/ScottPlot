...
public class Full : IAxisLimitManager
{
    ...
    public CoordinateRange GetRangeX(CoordinateRange viewRangeX, CoordinateRange dataRangeX)
    {
        ...
        double xMax = replaceRight ? dataRangeX.Max + (dataRangeX.Span * ExpansionRatio) : viewRangeX.Max;
    ...
    public CoordinateRange GetRangeY(CoordinateRange viewRangeY, CoordinateRange dataRangeY)
    {
        ...
        double yMax = replaceMax ? dataRangeY.Max + (dataRangeY.Span * ExpansionRatio) : viewRangeY.Max;
        ...
        double yMin = replaceMin ? dataRangeY.Min - (dataRangeY.Span * ExpansionRatio) : viewRangeY.Min;
