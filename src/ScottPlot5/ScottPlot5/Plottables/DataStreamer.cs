...
public class DataStreamer : IPlottable, IManagesAxisLimits, IHasLine, IHasLegendText
{
    ...
    {
        Renderer = new Wipe(this, true) { BlankFraction = blankFraction };
    }
    ...
    */
    ...
    public void UpdateAxisLimits(Plot plot)
    {
        ...
        AxisLimits limits = ScottPlot.AxisManager.GetLimits(Axes);
        ...
        _plot.Axes.SetLimits(newLimits, Axes.XAxis, Axes.YAxis);
    }
