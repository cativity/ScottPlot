...
public class LinePlot : IPlottable, IHasLine, IHasMarker, IHasLegendText
{
    ...
    public MarkerStyle MarkerStyle { get; set; } = new MarkerStyle { Size = 0 };
    ...
    {
        CoordinateRect boundingRect = new CoordinateRect(Start, End);
    ...
    {
        CoordinateLine line = new CoordinateLine(Start, End);
