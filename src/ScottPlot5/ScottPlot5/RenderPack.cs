...
public class RenderPack(Plot plot, PixelRect figureRect, SKCanvas canvas) : IDisposable
{
    ...
    public CanvasState CanvasState { get; } = new CanvasState(canvas);
    ...
    internal void CalculateLayout()
    {
        ...
        ScaledFigureRect = new PixelRect(FigureRect.Left / Plot.ScaleFactorF,
                                         FigureRect.Right / Plot.ScaleFactorF,
                                         FigureRect.Bottom / Plot.ScaleFactorF,
                                         FigureRect.Top / Plot.ScaleFactorF);
