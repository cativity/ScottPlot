...
{
    public string Name => "Dark Pastel";

    public string Description => "A qualitative 8-color palette generated using colorbrewer2.org";

    public Color[] Colors { get; } = Color.FromHex(_hexColors);

    private static readonly string[] _hexColors = ["#66c2a5", "#fc8d62", "#8da0cb", "#e78ac3", "#a6d854", "#ffd92f", "#e5c494", "#b3b3b3"];
