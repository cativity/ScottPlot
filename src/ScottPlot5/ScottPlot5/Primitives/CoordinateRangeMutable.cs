...
/// </summary>
public class CoordinateRangeMutable(double min, double max) : IEquatable<CoordinateRangeMutable>
{
    // TODO: rename class to MutableCoordinateRange or something
    ...
    public CoordinateRange ToCoordinateRange => new CoordinateRange(Min, Max);

    public CoordinateRange ToRectifiedCoordinateRange => Min < Max ? new CoordinateRange(Min, Max) : new CoordinateRange(Max, Min);

    public static CoordinateRangeMutable Infinity => new CoordinateRangeMutable(double.NegativeInfinity, double.PositiveInfinity);
    ...
    /// </summary>
    public bool Contains(double position) => position >= Min && position <= Max;
    ...
    /// </summary>
    public static CoordinateRangeMutable NotSet => new CoordinateRangeMutable(double.PositiveInfinity, double.NegativeInfinity);
    ...
    {
        return other is not null && Equals(Min, other.Min) && Equals(Min, other.Min);
    }

    public override bool Equals(object? obj)
    {
        return obj is CoordinateRangeMutable other && Equals(other);
    }

    public static bool operator ==(CoordinateRangeMutable a, CoordinateRangeMutable b) => a.Equals(b);
