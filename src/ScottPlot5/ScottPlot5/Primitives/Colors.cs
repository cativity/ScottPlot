...
public readonly struct Colors
{
    ...
    public static Color[] Category10 { get; } = new Category10().Colors;

    public static Color[] Category20 { get; } = new Category20().Colors;

    public static Color[] ColorblindFriendly { get; } = new ColorblindFriendly().Colors;
