...
public class ExpandingAxisLimits : IEquatable<ExpandingAxisLimits>
{
    ...
    public AxisLimits AxisLimits => new AxisLimits(Left, Right, Bottom, Top);
    ...
    public override string ToString() => $"Expanding Limits: X=[{Left}, {Right}] Y=[{Bottom}, {Top}]";
    ...
    {
        return other is not null && Equals(Left, other.Left) && Equals(Right, other.Right) && Equals(Top, other.Top) && Equals(Bottom, other.Bottom);
    }
    ...
    {
        return obj is ExpandingAxisLimits other && Equals(other);
    }

    public static bool operator ==(ExpandingAxisLimits a, ExpandingAxisLimits b) => a.Equals(b);

    public static bool operator !=(ExpandingAxisLimits a, ExpandingAxisLimits b) => !a.Equals(b);

    public static bool operator ==(ExpandingAxisLimits a, AxisLimits b) => a.Equals(b);
