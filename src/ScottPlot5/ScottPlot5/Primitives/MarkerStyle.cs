...
public class MarkerStyle : IHasLine, IHasFill, IHasOutline
{
    ...
    public LineStyle OutlineStyle { get; set; } = new LineStyle { Color = Colors.Black, Width = 0 };
    ...
    public static MarkerStyle Default => new MarkerStyle(MarkerShape.FilledCircle, 5);

    public static MarkerStyle None => new MarkerStyle(MarkerShape.None, 0);
