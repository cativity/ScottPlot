...
public class LegendItem : LabelStyleProperties, IHasMarker, IHasLine, IHasFill, IHasArrow, IHasLabel
{
    ...
    public override LabelStyle LabelStyle { get; set; } = new LabelStyle { Alignment = Alignment.MiddleLeft };
    ...
    public LineStyle OutlineStyle { get; set; } = new LineStyle { Width = 0 };
    ...
    public ArrowStyle ArrowStyle { get; set; } = new ArrowStyle();
    ...
    {
        LegendItem item = new LegendItem { LabelText = label, MarkerStyle = markerStyle, LineStyle = LineStyle.None, };
    ...
    {
        LegendItem item = new LegendItem { LabelText = label, MarkerStyle = markerStyle, LineStyle = lineStyle, };
    ...
    {
        LegendItem item = new LegendItem { LabelText = label, MarkerStyle = MarkerStyle.None, LineStyle = lineStyle, };
    ...
    {
        LegendItem item = new LegendItem { LabelText = label, MarkerStyle = MarkerStyle.None, FillStyle = fillStyle, LineStyle = LineStyle.None, };
    ...
    {
        LegendItem item = new LegendItem { LabelText = label, MarkerStyle = MarkerStyle.None, FillStyle = fillStyle, LineStyle = lineStyle, };
