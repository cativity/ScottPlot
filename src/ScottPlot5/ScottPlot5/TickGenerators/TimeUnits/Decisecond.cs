...
public class Decisecond : ITimeUnit
{
    ...
    public DateTime Snap(DateTime dt) => new DateTime(dt.Year, dt.Month, dt.Day, dt.Hour, dt.Minute, dt.Second, dt.Millisecond / 100 * 100);
    ...
    public DateTime Next(DateTime dateTime, int increment = 1) => dateTime.AddMilliseconds(increment * 100);
}
